...
REM ****************************************************************
Function CreateSong(title as string, artist as string, description as string, streamformat as string, feedurl as string, imagelocation as string, releaseDate as string) as Object
